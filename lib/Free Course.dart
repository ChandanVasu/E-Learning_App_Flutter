                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Image.network("https://uploads.tapatalk-cdn.com/20180804/67121b1f3f3212ec8e2a406987eb1cb4.gif", height: 20,)
                            ],
                          )
                        ],
                      ),
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          Youtube(VideoUrl: videourl, VideoTitle: title,VideoSubtitle: subtitle),
                    ),
                  );
                },
                child: Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        subtitle,
                        style: GoogleFonts.robotoSerif(
                            textStyle: TextStyle(fontWeight: FontWeight.bold, color: Colors.black54, fontSize: 13)),
                        overflow: TextOverflow.ellipsis,
                      ),
